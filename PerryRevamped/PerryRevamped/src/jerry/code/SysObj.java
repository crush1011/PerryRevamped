...
public interface SysObj {
	...
	public static enum Constants implements SysObj{
		
		//collector constants
		COLLECTOR_PICKUP("COLLECTOR_PICKUP"),
		COLLECTOR_SCORING("COLLECTOR_SCORING"),
		COLLECTOR_CARRYING("COLLECTOR_CARRYING"),
		COLLECTOR_POTTO90("COLLECTOR_POTTO90"),
		COLLECTOR_GIVEFACTOR("COLLECTOR_GIVEFACTOR"),
		COLLECTOR_PID("COLLECTOR_PID"),
		
		//driveTrain Constants
		DRIVETRAIN_TICKTOIN("DRIVETRAIN_TICKTOIN"),
		;
		
		public String name;
		
		// Constructor for the Constant Enum
